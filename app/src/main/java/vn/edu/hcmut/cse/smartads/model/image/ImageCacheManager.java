...
public class ImageCacheManager{
    ...
    public static int DISK_IMAGECACHE_QUALITY = 100;  //PNG is lossless so quality is ignored
     ...
     */
    private ImageClearCache mImageCache;
     ...
     * @param quality
     */
    public void init(Context context, RequestQueue requestQueue, String uniqueName, int cacheSize, CompressFormat compressFormat, int quality, CacheType type){
        switch (type) {
            case DISK:
